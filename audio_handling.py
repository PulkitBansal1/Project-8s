...
import numpy as np                                          #open source python library that provides a multidimensional array object, various derived objects etc.
from pydub import AudioSegment


class AudioFrameHandler:

    def __init__(self, sound_file_path: str = ""):          #To play/pass custom audio based on some event
